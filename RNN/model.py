...
class RNN(object):
    def __init__(self,
        ...
        outputs, states = tf.nn.bidirectional_dynamic_rnn(cell_fw, cell_bw, self.embed_input, sequence_length=self.texts_length,
        ...
        with tf.variable_scope('logits'):
            ...
            flatten_M = tf.reshape(M,
                                   shape=[batch_size, param_r * 2 * num_units])  # shape: [batch, param_r*2*num_units]
